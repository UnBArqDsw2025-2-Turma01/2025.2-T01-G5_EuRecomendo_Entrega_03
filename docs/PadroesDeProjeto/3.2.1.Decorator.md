...
![Diagrama2](../assets/DecoratorReview.png)
...
```bash
docker compose exec web python test_decorators.py
```

### Vídeo

<font size="2"><p style="text-align: center">Vídeo 2 - Decorator Method </p></font>

<center>
<iframe width="560" height="315" src="https://www.youtube.com/embed/yL1dl75kk44" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</center>
...
| 0.3    | 23/10/2025 | Adição do código e vídeo                    | [Sophia Silva](https://github.com/sophiassilva), [Renan Vieira]() |[Jose Eduardo](https://github.com/jevprado)  |                     |
| 0.4    | 23/10/2025 | Pequenas correções                 | [Renan Vieira](https://github.com/R-enanVieira), [Sophia Silva](https://github.com/sophiassilva) |[Jose Eduardo](https://github.com/jevprado)  |                     |
...
| 0.6    | 24/10/2025 | Adicionando vídeo decorator               | [Jose Eduardo](https://github.com/jevprado) |  [Renan Vieira](https://github.com/R-enanVieira) |                     |
