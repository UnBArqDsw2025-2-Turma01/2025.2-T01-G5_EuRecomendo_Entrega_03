...
<font size="2"><p style="text-align: center"><b>Figura 2:</b> Diagrama Strategy - Review</div>

<div style="text-align: center;">

![Diagrama2](../assets/StrategyReview.png)
...
Foram implementados os códigos no padrão **Strategy**, permitindo a análise de avaliações de livros usando diferentes estratégias.  
Cada estratégia é independente e pode ser aplicada dinamicamente ao contexto de análise.
...
class ReviewCalculationStrategy(ABC):
    ...
    Define o método `calculate`, que deve ser implementado por todas as estratégias concretas.
    """
...
### 2.4 SentimentBasedRatingStrategy
...
```
#### 7. Para rodar o teste 
```bash
docker compose exec web python test_review_strategies.py.py
```
...
<center>
<iframe width="560" height="315" src="https://www.youtube.com/embed/qCVY5BU-Go8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</center>
...
| 1.1    | 24/10/2025 | Adição do código strategy                    | [Jose Eduardo](https://github.com/jevprado) | [Sophia Silva](https://github.com/sophiassilva) |                     |
| 1.2    | 24/10/2025 | Adição do vídeo strategy                  | [Jose Eduardo](https://github.com/jevprado) | [Sophia Silva](https://github.com/sophiassilva) |                     |